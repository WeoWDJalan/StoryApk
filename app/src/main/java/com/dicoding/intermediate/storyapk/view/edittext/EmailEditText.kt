package com.dicoding.intermediate.storyapk.view.edittext
    ...
    private fun init() {
        ...
        addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence, start: Int, before: Int, count: Int) {
                error = if (s.isNotEmpty() && !emailRegex.matches(text.toString())) resources.getString(R.string.emailFormatError) else null
            }
